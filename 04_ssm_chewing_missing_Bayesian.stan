// The only difference from 02_ssm_chewing_sync_missing.stan is that "is_real" has been changed to "is_visible".
...
data {
  ...
  int<lower=0,upper=1> is_visible[N];  // visible=1, invisible=0
