...
# -*- coding: utf-8 -*-
"""
08_plot_figure_S2_gridnull_v2.py
...
Usage (local, from ROOT/gridnull_main, conda env nieh_iscience_2026):
  python 08_plot_figure_S2_gridnull_v2.py \
...
timelines_all_master.csv (v1 crashed on the duplicated index:
...
# colorblind-safe palette (Okabe-Ito). Assignment fixed 2026-09-02 (user
# report: visible/invisible were swapped): visible = vermillion (warm),
# invisible = blue, matching Figure 4a-d (visible warm / invisible blue).
COLORS = {"visible": "#D55E00", "invisible": "#0072B2"}
